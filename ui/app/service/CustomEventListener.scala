 ...
 */
class CustomEventListener extends EventListener[MultiProfileUser] {
  def onEvent(event: Event[MultiProfileUser], request: RequestHeader, session: Session): Option[Session] = {
